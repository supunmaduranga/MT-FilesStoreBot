    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("💻 Tutorial Video 💻", url="https://www.youtube.com/channel/UCvYfJcTr8RY72dIapzMqFQA?sub_confirmation=1")
                    ],
                    [
        ...
        try:
            ...
            await send_stored_file.reply_text(
                f"**Here is Sharable Link of this file:** https://t.me/{Config.BOT_USERNAME}?start=slbotzones{file_id}\n\n__To Retrive the Stored File, just open the link!__",
...
async def main(bot: Client, message: Message):
    if message.chat.type == "private":
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=slbotzones{file_er_id}"
            await editable.edit(
                f"**Your File Stored in my Database 🗂️!**\n\nHere is the Permanent Link of your file: {share_link} \n\nJust Click the link to get your file!",
                parse_mode="Markdown",
                reply_markup=InlineKeyboardMarkup(
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/slbotzone).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
